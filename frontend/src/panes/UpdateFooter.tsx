...
import ReportSheet, { Card } from "./ReportSheet";
...
export default function UpdateFooter({
  ...
  // The report is its own sheet, shared with the drawer's foot inside a
  // project.
  if (open === "report") return <ReportSheet onClose={onClose} />;
