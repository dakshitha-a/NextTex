...
`.claude/`, `TRACKER.md`, `ROADMAP.md`, `REVIEW.md`, `.gitignore`,
`.gitattributes`) leaves it alone; the update footer is already quiet
about those commits and the number agrees with it.
