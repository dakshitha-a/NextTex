        ...
        if self.voice_summary.exists():
            ...
            if text:
                parts.append(
                    ...
                    "writes, taken from their own work."
                )
    ...
    def distillation_request(self, kind: Kind) -> tuple[str, Path] | None:
        ...
        if kind == "style":
            ...
            instruction = (
                ...
                "Record what is observable, not what is flattering. Typical "
                "sentence length and how much it varies. Whether paragraphs open "
                "with their topic sentence. The transitions they actually use. How "
                "they introduce a technical term the first time. Their citation "
                "style. How they handle the first person. What they consistently "
                "do NOT do.\n\n"
                "Quote two or three short phrases as evidence.\n\n"
